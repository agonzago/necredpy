...
def extract_model_equations(mod_string):
    ...
    the parentheses after `model`):
      ...
      nocredibility  : declares that the model does NOT have a
                       ...
                       would normally require one (parse_credibility_mod,
...
def parse_mod(mod_string, verbose=False, coefficient_names=None):
    ...
    result = {
        ...
        #                    block; downstream code (parse_credibility_mod,
...
# ---------------------------------------------------------------------------
# Top-level dispatcher: parse_credibility_mod
# ---------------------------------------------------------------------------
#
# Unified entry point for .mod files with a credibility; ... end; block.
# Reads model(target) to decide the solution target, parses both the
# model; and credibility; blocks, and returns all parsed components.
...
def parse_credibility_mod(mod_string, verbose=False):
    ...
    # (Legacy extract_credibility fallback removed.)
